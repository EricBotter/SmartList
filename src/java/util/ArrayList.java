...
public class ArrayList<E> extends AbstractList<E>
    ...
    public ArrayList(int initialCapacity) {
        ...
        customInit();
        traceCall("<init>", new String[]{Integer.toString(initialCapacity)}, 0, 0, allocationSite);
    }
    ...
    public ArrayList() {
        ...
        isProfilable = checkIsProfilable();
        customInit();
        traceCall("<init>", null, 0, 0, allocationSite);
    }
    ...
    public int indexOf(Object o) {
        if (o == null) {
            for (int i = 0; i < size; i++)
                if (elementData[i] == null) {
                    traceCall("indexOf", new String[]{"Object"}, i);
                    return i;
                }
        } else {
            for (int i = 0; i < size; i++)
        ...
        traceCall("indexOf", new String[]{"Object"}, size);
        return -1;
    }
    ...
    public int lastIndexOf(Object o) {
        if (o == null) {
            for (int i = size - 1; i >= 0; i--)
                if (elementData[i] == null) {
                    traceCall("indexOf", new String[]{"Object"}, size - i);
                    return i;
                }
        } else {
            for (int i = size - 1; i >= 0; i--)
    ...
    public boolean add(E e) {
        traceCall("add", new String[]{"Object"}, 1, 1);
    ...
    public boolean remove(Object o) {
        if (o == null) {
            for (int index = 0; index < size; index++)
                if (elementData[index] == null) {
                    traceCall("remove", new String[]{"Object"}, size, index);
                    fastRemove(index);
                    return true;
                }
        } else {
        ...
        traceCall("remove", new String[]{"Object"}, size, size);
    ...
    public void clear() {
        ...
        traceCall("clear", null, size, size);
    ...
    public boolean addAll(Collection<? extends E> c) {
        Object[] a = c.toArray();
        int numNew = a.length;
        traceCall("addAll", new String[]{"Collection"}, numNew);
    ...
    private boolean batchRemove(Collection<?> c, boolean complement) {
        ...
        traceCall(complement ? "retainAll" : "removeAll", new String[]{"Collection"}, size);
        try {
            for (; r < size; r++)
    ...
    private boolean checkIsProfilable() {
    ...
    private void customInit() {
        ...
        id = globalCounter++;
        this.allocationSite = extractAllocationSite();
    }
    ...
    private void traceCall(String method, String[] arguments) {
        traceCall(method, arguments, 0, 0, null);
    }

    private void traceCall(String method, String[] arguments, int impact) {
        traceCall(method, arguments, impact, impact, null);
    }

    private void traceCall(String method, String[] arguments, int impactArray, int impactList) {
        traceCall(method, arguments, impactArray, impactList, null);
    }
     ...
     */
    private void traceCall(String method, String[] arguments, int impactArray, int impactList, String allocationSite) {
        if (!isProfilable) return;
        ...
        try {
            ...
            sb.append(size);
            sb.append(',');
            sb.append(impactArray);
            sb.append(',');
            sb.append(impactList);
            sb.append(',');
            sb.append(allocationSite == null ? "" : allocationSite);
